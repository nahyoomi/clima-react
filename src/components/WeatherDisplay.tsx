...
const WeatherDisplay: React.FC = () => {
  ...
  return (
    <div className="relative max-w-xl mx-auto bg-white bg-opacity-80 backdrop-filter backdrop-blur-lg rounded-xl shadow-lg p-6 md:p-10 mt-8">
      {/* Encabezado */}
      <button
        onClick={handleAddFavorite}
        className="absolute top-4 right-4 transform transition-transform duration-200 hover:scale-125 focus:scale-125"
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mt-6">
        ...
        <button
          onClick={toggleUnit}
          className="mt-4 md:mt-0 px-4 py-2 bg-black text-white rounded hover:bg-gray-900 focus:outline-none flex items-center"
        >
          <FaExchangeAlt className="mr-2" /> Cambiar a °
          {unit === "C" ? "F" : "C"}
        </button>
      </div>
